// 📁 index.js (Versión con Anti-Crash y Correcciones Finales)
...
`));
    ...
    // Manejo de la conexión IPC (para reinicio forzado por comando, ej. !restart)
    p.on('message', data => {
        if (data === 'reset') {
...
// ===================================================
// FUNCIÓN PRINCIPAL DEL BOT (mainBotLogic)
// ===================================================
...
// Lógica de arranque del proceso.
if (process.argv[1] === fileURLToPath(import.meta.url)) {
    // Proceso principal: lanza el proceso hijo y maneja el Anti-Crash.
    start();
} else {
    // Proceso hijo: ejecuta la lógica principal del bot.
    mainBotLogic();
}